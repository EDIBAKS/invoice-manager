...
//these are commands to execute methods when the app first runs

created(){
  //this function is simply capturing the selected invoice by number to store its value in [currentInvoice]
this.getCurrentInvoice()

},
//specific instructions of system functionality
methods:{
